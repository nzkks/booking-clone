...
const staysProducts = [
  ...
  {
    name: 'Book a Flight',
    description: 'Spak directly to your customers',
    href: '#',
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map(item => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 font-semibold leading-6 text-[#013B94] hover:bg-gray-100"
                    >
